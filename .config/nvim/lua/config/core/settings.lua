...
vim.opt.timeoutlen = 500               -- Milliseconds to wait for mapped sequence to complete.
vim.opt.ttimeoutlen = 1                -- Milliseconds to wait for key code sequence to complete.
